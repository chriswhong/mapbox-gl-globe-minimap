...
Minimap.prototype = Object.assign({}, mapboxgl.NavigationControl.prototype, {
    ...
    _load: async function () {
        ...
        this.projection = d3.geoOrthographic().fitExtent([[0, 0], [globeSize, globeSize]], { type: "Sphere" })
    ...
    _update: function () {
        ...
        d3.transition()
            ...
            .tween("rotate", function () {
                const r = d3.interpolate(that.projection.rotate(), [-parentCenter.lng, -parentCenter.lat]);
                return function (t) {
                    that.projection.rotate(r(t));
                    that.context.clearRect(0, 0, that.options.width, that.options.height);
    ...
    _createContainer: function (parentMap) {
        ...
        container.setAttribute('style', 'width: ' + globeSize + '; height: ' + globeSize + ';');
